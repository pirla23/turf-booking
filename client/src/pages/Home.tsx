        ...
        >
          ...
          <div className="flex flex-col items-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg glass border border-white/5 text-sm font-medium text-white hover:border-[#E1306C]/30 hover:bg-[#E1306C]/10 transition-all duration-300 group"
            >
              ...
              <span className="text-white group-hover:text-[#E1306C] transition-colors">@akans_arena__</span>
            </a>
