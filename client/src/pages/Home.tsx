        ...
        >
          ...
          <div className="flex flex-col items-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-3 px-8 py-3.5 rounded-xl bg-gradient-to-r from-[#E1306C]/10 to-[#833AB4]/10 border border-[#E1306C]/30 text-base font-semibold text-white hover:border-[#E1306C]/60 hover:shadow-[0_0_20px_rgba(225,48,108,0.3)] transition-all duration-300 group"
            >
              ...
              <span className="text-white group-hover:text-[#E1306C] transition-colors">Follow @akans_arena__</span>
            </a>
