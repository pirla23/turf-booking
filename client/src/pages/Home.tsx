        ...
        >
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            >
              ...
              <span className="group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-[#fdf497] group-hover:via-[#fd5949] group-hover:to-[#d6249f] group-hover:bg-clip-text transition-all"> @akans_arena__</span>
            </a>
